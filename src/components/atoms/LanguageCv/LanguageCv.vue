<template>
  <div class="lang">
    <div class="lang--cover">
      <div class="lang--wrap">
        <div class="lang__name">{{ name.toUpperCase() }}</div>
      </div>
    </div>
  </div>
</template>
...
.lang__name {
  ...
  box-shadow: -1.83074px -2.7461px 7.32294px #fafafc,
    0.915368px 0.915368px 4.57684px #b1b5c6,
    inset 0.915368px 0.915368px 2.7461px #ebecf0;
  aspect-ratio: 1;
}
</style>
